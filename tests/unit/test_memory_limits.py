...
class TestMemoryLimits:
    ...
    def test_memory_limit_prevents_oom_killer(self):
        ...
        try:
            ...
            print(f"✅ Processed {len(huge_content)} lines using {memory_increase:.3f}GB additional memory")
    ...
    def test_memory_limit_with_different_processing_modes(self):
        ...
        try:
            ...
            for mode in modes:
                ...
                print(f"✅ Mode {mode}: processed to {len(result)} lines, used {memory_used:.3f}GB")
    ...
    def test_memory_monitor_integration(self):
        ...
        try:
            ...
            assert any(keyword in stats_str for keyword in 
                      ['memory', 'mb', 'usage', 'peak']), f"Stats missing memory info: {stats}"
